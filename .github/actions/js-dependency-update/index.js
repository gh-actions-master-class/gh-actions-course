...
async function run() {
    ...
    if(!validateBranchName({branchName: targetBranch})){
        // core.error('Invalid target-branch name. Branch names should include only charcters, numbers, hyphens, underscores, dots and forward slashes.')
        core.setFailed('Invalid target-branch name. Branch names should include only charcters, numbers, hyphens, underscores, dots and forward slashes.');
        return;
    }

    if(!validateDirectoryName({dirName: targetBranch})){
